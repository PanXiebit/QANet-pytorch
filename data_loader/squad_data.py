...
from utils.file_utils import pickle_dump_large_file, pickle_load_large_file
...
def prepro(config):
    ...
    train_examples, train_meta, train_eval = get_examples(
        config.train_file, "train", word_counter, char_counter, debug=config.debug)
    dev_examples, dev_meta, dev_eval = get_examples(
        config.dev_file, "dev", word_counter, char_counter, debug=config.debug)
